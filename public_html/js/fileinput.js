...
(function ($) {
    ...
    var PREVIEW_TEMPLATE = '<div class="file-preview {class}">\n' +
        ...
        '   <div class="close fileinput-remove text-right" id="closeFileInput">&times;</div>\n' +
    ...
    var FileInput = function (element, options) {
        ...
        this.ExaminarLabel = options.ExaminarLabel;
        this.ExaminarIcon = options.ExaminarIcon;
        this.ExaminarClass = options.ExaminarClass;
    ...
    FileInput.prototype = {
        ...
        renderMain: function () {
            ...
            return self.mainTemplate.replace('{class}', self.mainClass).
                ...
                replace('{Examinar}', self.renderExaminar());
        },
        renderExaminar: function () {
            var self = this, css = self.ExaminarClass + ' btn-file', status = '';
            if (self.isDisabled) {
                status = ' disabled ';
            }
            return '<div class="' + css + '"' + status + '> ' + self.ExaminarIcon + self.ExaminarLabel + ' </div>';
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        ExaminarLabel: 'Examinar &hellip;',
        ExaminarIcon: '<i class="glyphicon glyphicon-folder-open"></i> &nbsp;',
        ExaminarClass: 'btn btn-primary',
        removeLabel: 'Remove',
